...
| 任务 | 优先级 | 周期/特点 | 主要功能 |
|---|---:|---|---|
| `task_collect` | 1 | 1 秒 | 读取 DS1302Z 和 DHT11 |
| `task_show` | 2 | 由显示刷新延时控制 | 显示时间、温湿度和设置页面 |
| `task_switch` | 3 | 50 ms | 扫描按键、拨动开关、触摸和麦克风 |
| `task_alarm` | 4 | 1 秒 | 判断闹钟并控制 NV020D |
| `task_volume` | 4 | 50 ms | 调节音量和试听语音 |
